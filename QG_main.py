...
parser.add_argument(
    '--train_file',
    default=data_folder + 'original/SQuAD1.1-Zhou/train.txt',
    type=str, help='path of train dataset')
parser.add_argument(
    '--dev_file',
    default=data_folder + 'original/SQuAD1.1-Zhou/dev.txt',
    type=str, help='path of dev dataset')
parser.add_argument(
    '--test_file',
    default=data_folder + 'original/SQuAD1.1-Zhou/test.txt',
    type=str, help='path of test dataset')
parser.add_argument(
    '--train_examples_file',
    default=data_folder + 'processed/SQuAD1.1-Zhou/train-v1.1-examples.pkl',
    type=str, help='path of train dataset examples file')
parser.add_argument(
    '--dev_examples_file',
    default=data_folder + 'processed/SQuAD1.1-Zhou/dev-v1.1-examples.pkl',
    type=str, help='path of dev dataset examples file')
parser.add_argument(
    '--test_examples_file',
    default=data_folder + 'processed/SQuAD1.1-Zhou/test-v1.1-examples.pkl',
    type=str, help='path of test dataset examples file')
parser.add_argument(
    '--train_spacy_processed_examples_file',
    default=data_folder + 'processed/SQuAD1.1-Zhou/train-v1.1-spacy-processed-examples.pkl',
    type=str, help='path of train dataset spacy processed examples file')
parser.add_argument(
    '--dev_spacy_processed_examples_file',
    default=data_folder + 'processed/SQuAD1.1-Zhou/dev-v1.1-spacy-processed-examples.pkl',
    type=str, help='path of dev dataset spacy processed examples file')
parser.add_argument(
    '--test_spacy_processed_examples_file',
    default=data_folder + 'processed/SQuAD1.1-Zhou/test-v1.1-spacy-processed-examples.pkl',
    type=str, help='path of test dataset spacy processed examples file')
parser.add_argument(
    '--train_meta_file',
    default=data_folder + 'processed/SQuAD1.1-Zhou/train-v1.1-meta.pkl',
    type=str, help='path of train dataset meta file')
parser.add_argument(
    '--dev_meta_file',
    default=data_folder + 'processed/SQuAD1.1-Zhou/dev-v1.1-meta.pkl',
    type=str, help='path of dev dataset meta file')
parser.add_argument(
    '--test_meta_file',
    default=data_folder + 'processed/SQuAD1.1-Zhou/test-v1.1-meta.pkl',
    type=str, help='path of test dataset meta file')
parser.add_argument(
    '--train_eval_file',
    default=data_folder + 'processed/SQuAD1.1-Zhou/train-v1.1-eval.pkl',
    type=str, help='path of train dataset eval file')
parser.add_argument(
    '--dev_eval_file',
    default=data_folder + 'processed/SQuAD1.1-Zhou/dev-v1.1-eval.pkl',
    type=str, help='path of dev dataset eval file')
parser.add_argument(
    '--test_eval_file',
    default=data_folder + 'processed/SQuAD1.1-Zhou/test-v1.1-eval.pkl',
    type=str, help='path of test dataset eval file')
parser.add_argument(
    '--train_output_file',
    default=data_folder + 'processed/SQuAD1.1-Zhou/train_output-v1.1.txt',
    type=str, help='path of train result file')
parser.add_argument(
    '--eval_output_file',
    default=data_folder + 'processed/SQuAD1.1-Zhou/eval_output-v1.1.txt',
    type=str, help='path of evaluation result file')
parser.add_argument(
    '--test_output_file',
    default=data_folder + 'processed/SQuAD1.1-Zhou/test_output-v1.1.txt',
    type=str, help='path of test result file')
parser.add_argument(
    '--emb_mats_file',
    default=data_folder + 'processed/SQuAD1.1-Zhou/emb_mats.pkl',
    type=str, help='path of embedding matrices file')
parser.add_argument(
    '--emb_dicts_file',
    default=data_folder + 'processed/SQuAD1.1-Zhou/emb_dicts.pkl',
    type=str, help='path of embedding dicts file')
parser.add_argument(
    '--counters_file',
    default=data_folder + 'processed/SQuAD1.1-Zhou/counters.pkl',
